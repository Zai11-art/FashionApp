function ServiceSect(props) {
  ...
  return (
    <div className=" glass-component">
      ...
      <div className="bg-cover bg-center cta-card w-[100%] lg:h-[700px]  md:h-[1300px] h-[2500px]"></div>
    </div>
  );
}
