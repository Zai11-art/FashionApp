...
function NewsSect () {
    let article = [
        {
            ...
            excerpt:"Introduction Fashion is ever-evolving, and staying on-trend can be a challenge. That's where POP Fashion comes in, offering the latest styles for women to help them look their best. Whether you're…",
            author:"Ali Bajwa",
            link: "https://filmdaily.co/fashion/pop-fashion-latest-styles-for-women/",
            image: "https://filmdaily.co/wp-content/uploads/2023/03/Screenshot-2023-03-21-193243.png"
        },
        {
            title:"7 TikTok Fashion Trends That Will Be Everywhere This Spring",
            excerpt:"Spring is here and these TikTok trends are already everywhere. The millions of views they've racked up prove my point.",
            author:"Sierra Mayhew",
            link: "https://www.whowhatwear.com/spring-tiktok-trends-2023",
            image: "https://cdn.cliqueinc.com/posts/306226/spring-tiktok-trends-2023-306226-1679447773976-fb.700x0c.jpg"
        },
        {
            title:"Five spring and summer fashion trends to look out for",
            excerpt:"With the arrival of Spring, it's time to start weaving the fashion trends of 2023 into your closet. Influenced by the fashion shows from New York, London, Milan and Paris,",
            author:"Ali B22ajwa",
            ...
            image: "https://bloximages.newyork1.vip.townnews.com/richmond.com/content/tncms/assets/v3/editorial/a/b7/ab7ccd39-0c3e-5216-a228-6817484da298/6418ac136780f.image.jpg?crop=320%2C168%2C0%2C5&resize=320%2C168&order=crop%2Cresize"
        },
    ...
    return ( 
        ...
        <div className=" glass-component">
            ...
            <div className="glass-hero absolute flex flex-col items-center pt-[50px]  ">
            <h1 className="text-5xl text-white mb-10"><i>Browse the Latest News</i> </h1>
                {
                    article.slice(0,11).map(article => {
                        ...
                        // </div>
                        <AnimationOnScroll animateOnce={true} animatePreScroll animateIn="animate__fadeInLeft">
                        <div className=" lg:w-[900px] md:w-[750px] w-[400px] lg:h-[300px] md:h-[300px] h-[600px] bg-[white]  p-2  mt-5 border-[3px] drop-shadow-2xl 
                        flex md:flex-row flex-col md:flex-nowrap flex-wrap rounded-xl  opacity-95">
                            <div className="lg:w-[430px] md:w-[330px] w-[377.5px] lg:h-[300px] md:h-[278px] h-[290px] rounded-lg" ><img className="lg:w-[430px] md:w-[330px] w-[377.5px] lg:h-[280px] md:h-[278px] h-[290px] rounded-lg" src={article.image} alt="" /></div>
                            <div className="lg:w-[430px] md:w-[330px]  w-[377.5px] flex flex-col md:mx-4 mx-1 px-2" >
                                <h1 className="md:text-3xl text-xl md:pt-2 pt-3">{article.title}</h1>
                                <h2 className=" md:pt-2 pt-3"> <i> {article.excerpt}</i></h2>
                                <div className="lg:pt-[70px] md:pt-[20px] pt-[40px]  pb-2 flex-row flex justify-between">
                                    <span className=""><i> - {article.author}</i></span>
                                    <span className="span-material underline"><a href={article.link} className="">Read more.</a></span>
                                </div>
                            </div>
                        </div>
                        </AnimationOnScroll>
            ...
            <div className="bg-cover bg-center cta-card w-[100%] md:h-[4000px] h-[5600px]">
            </div>
