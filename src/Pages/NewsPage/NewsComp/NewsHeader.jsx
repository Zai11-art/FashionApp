...
function NewsHeader () {
    return ( 
        ...
        <div className=" glass-component shadow-lg">
            <div className="glass-hero absolute z-[1] flex flex-row md:justify-around justify-center  flex-wrap ">
                <div className="z-[2] md:w-[400px] h-[450px] bg-[white] z-[5] p-5 w-[400px] md:mt-[100px] mt-[50px]
            ...
            <div className="bg-cover bg-center news-image">
            </div>
