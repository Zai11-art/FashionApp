    ...
    return ( 
        ...
        <div className=" glass-component">
            <div className="glass-hero absolute z-[1] flex flex-row justify-center m-0 pt-[50px] flex-wrap ">
                ...
                ">
                    <h1 className="mt-7 mb-4"><span className="text-4xl">Regist<span className="span-material">er</span></span></h1>
                    ...
                    <div className="mt-4">
                        <a href="/Login" className="underline text-[0.75em] text-red-500">Login Instead</a>
                    </div>
